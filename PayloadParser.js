            ...
            case 'report_telemetry':
                switch (message.measurementId) {
                    case 4101: // Pressure
                        ...
                        if (sensor1 != null)
                            sensor1.updatePressureSensorStatus(message.measurementValue);
                        break;
                                   // Add more cases for other measurement types if needed
                }
                break;
            case 'upload_sensor_id':
                // Handle upload_sensor_id
                // You can access the sensor ID using message.sensorId
                break;
            case 'upload_battery':
                // Handle upload_battery
